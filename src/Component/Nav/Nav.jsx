...
export default function Nav() {
  ...
  return (
    <>
      <div className="navbar bg-second-color text-white flex justify-center fixed top-0 start-0 end-0 z-40 py-5 px-4 transition-all duration-[0.5s] xl:px-44">
        <div className="container flex justify-between flex-wrap mx-auto">
          ...
          <ul className="hidden md:flex links justify-between list-none gap-4">
            <li>
          ...
          {navTool && (
            <ul className="flex lg:hidden justify-between flex-col items-start list-none gap-4 w-full">
              <li>
                <NavLink
                  to="about"
